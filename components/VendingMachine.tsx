...
// diamond thirteen times over, so the machine reads as stocked rather
...
const SLOTS: Slot[] = [
  ...
  ...PLACEHOLDER_PRICES.map((price, i): Slot => ({ kind: "placeholder", name: "Coming Soon", price, icon: PLACEHOLDER_ICONS[i] })),
];
